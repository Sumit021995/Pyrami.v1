...
public class Test_Leads_001 {
	...
	public  void leads_001() throws Exception{
		...
		Row row = wb.getSheet("Leads").getRow(2);
		String firstName1 = row.getCell(1).toString();
		String lastName1= row.getCell(2).toString();
		String company1= row.getCell(3).toString()+Math.floor(Math.random()*1000);
//		String industry3 = row.getCell(4).toString();s
//		String type3 = row.getCell(5).toString();
...
//		String memberOf = row.getCell(7).toString();
		...
		driver.findElement(By.name("firstname")).sendKeys(firstName1,Keys.TAB,Keys.TAB,lastName1,Keys.TAB,Keys.TAB,company1);
		 ...
		 * driver.findElement(By.id("dtlview_No Of Employees")).getText(); String
		 * phoneComfirmationText = driver.findElement(By.id("dtlview_Phone")).getText();
		 * String emailComfirmationText =
		 * driver.findElement(By.id("dtlview_Email")).getText(); String
		 * websiteComfirmationText =
		 * driver.findElement(By.id("dtlview_Website")).getText(); String
		...
		Assert.assertTrue(comfirmationText.contains(firstName1));
		Assert.assertTrue(comfirmationText.contains(lastName1));
		Assert.assertTrue(firstNameComfirmationText.equals(firstName1));
		Assert.assertTrue(lastNameComfirmationText.equals(lastName1));
		Assert.assertTrue(titleComfirmationText.contains("Mr."));
		Assert.assertTrue(companyComfirmationText.equals(company1));
